...
describe('Notification e2e test', () => {
  ...
  const notificationSample = {
    date: '2022-11-01T10:55:41.457Z',
    sentDate: '2022-11-01T11:22:44.531Z',
    format: 'EMAIL',
    userId: 20600,
    productId: 75536,
  };
  ...
  describe('new Notification page', () => {
    ...
    it('should create an instance of Notification', () => {
      cy.get(`[data-cy="date"]`).type('2022-10-31T18:24').blur().should('have.value', '2022-10-31T18:24');

      cy.get(`[data-cy="details"]`).type('firewall multimedia').should('have.value', 'firewall multimedia');

      cy.get(`[data-cy="sentDate"]`).type('2022-11-01T04:03').blur().should('have.value', '2022-11-01T04:03');
