...
describe('ProductOrder e2e test', () => {
  ...
  // const productOrderSample = {"placedDate":"2022-11-01T14:23:47.294Z","status":"CANCELLED","code":"Buckinghamshire"};
  ...
  describe('new ProductOrder page', () => {
    ...
    it.skip('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2022-11-01T08:35').blur().should('have.value', '2022-11-01T08:35');
