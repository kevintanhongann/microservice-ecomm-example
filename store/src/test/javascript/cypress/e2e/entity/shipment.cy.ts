...
describe('Shipment e2e test', () => {
  ...
  const shipmentSample = { date: '2022-10-31T17:52:40.261Z' };
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      ...
      body: {
        code: 'robust scale',
        date: '2022-11-01T10:31:41.314Z',
        details: 'withdrawal sensor',
        status: 'PAID',
        paymentMethod: 'CREDIT_CARD',
        paymentDate: '2022-10-31T16:15:41.996Z',
        paymentAmount: 16937,
      },
    }).then(({ body }) => {
      invoice = body;
  ...
  describe('new Shipment page', () => {
    ...
    it('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-10-31T19:18').blur().should('have.value', '2022-10-31T19:18');
