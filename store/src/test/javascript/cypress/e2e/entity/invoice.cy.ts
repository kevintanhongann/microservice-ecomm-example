...
describe('Invoice e2e test', () => {
  ...
  const invoiceSample = {
    ...
    date: '2022-11-01T09:56:53.347Z',
    status: 'ISSUED',
    paymentMethod: 'CASH_ON_DELIVERY',
    paymentDate: '2022-11-01T13:10:38.969Z',
    paymentAmount: 88901,
  };
  ...
  describe('new Invoice page', () => {
    ...
    it('should create an instance of Invoice', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2022-11-01T11:04').blur().should('have.value', '2022-11-01T11:04');
      ...
      cy.get(`[data-cy="paymentDate"]`).type('2022-11-01T03:13').blur().should('have.value', '2022-11-01T03:13');
